...
const ItemCardNavigate = () => {
  ...
  return (
    <div className=''>
        ...
        <div className='relative flex ml-40 mt-2'>
        <div className='flex-col h-20 w-20 mr-5'>{product.images.map((e) => <img className='border-2 border-gray-950 m-2' src={e} alt="imgthumbnail"/> )                
            }</div>
            ...
            <div className='text-lg text-amber-600 font-semibold'>{product.title}</div>
            <div className='text-md text-black font-medium'>{product.description}</div>
            
            <div className='text-green-700 font-medium text-xl'>Price <span className='text-black'>Rs. {product.discountPercentage}</span>
